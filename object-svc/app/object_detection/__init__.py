...
def detectObj(root_url, filename, filepath, ini_confidence=0.5, ini_threshold=0.3):
    ...
    weightsPath = os.path.join('object_detection/yolo-coco/yolov3.weights')
    configPath = os.path.join('object_detection/yolo-coco/yolov3.cfg')
    ...
    if image.shape:
        ...
        # boxes
        idxs = cv2.dnn.NMSBoxes(boxes, confidences, ini_confidence,
                                ini_threshold)
